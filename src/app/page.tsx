        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-28">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              AI가 뉴스, 논문, 기술 블로그를 요약 및 정리하여 맞춤형 브리핑을 제공하는 시스템입니다. 관심 있는 산업과
              키워드를 설정하고, 최신 정보를 쉽게 받아보세요.
            </p>
      ...
      <div className="bg-gray-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              최신 뉴스와 논문을 AI가 분석하여 핵심 정보만 제공합니다. 관심 분야에 맞는 맞춤형 정보를 받아보세요.
            </p>
          </div>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
              <div className="relative pl-16">
                ...
                <dd className="mt-2 text-base leading-7 text-gray-600">
                  AI가 최신 뉴스를 자동으로 수집하고 요약하여 핵심 정보만 제공합니다. 시간을 절약하면서 중요한 정보를
                  놓치지 마세요.
                </dd>
              </div>
              <div className="relative pl-16">
      ...
      <div className="bg-white py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">지금 바로 시작하세요</h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
              회원가입 후 관심 키워드를 설정하고 맞춤형 뉴스 브리핑을 받아보세요.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Button className="px-6 py-6 text-base">무료로 시작하기</Button>
